...
export class ProductCategory extends Component {
    ...
    render() {
        const prodCategory = [...this.props.products.filter(product => product.category === this.props.categName)]
        ...
        let products = prodCategory.map((filteredProduct, index) => (
            <div className={styles.productHolder} key={index}>
             ...
             descript={filteredProduct.description}
              price={filteredProduct.price} img={filteredProduct.img}
              clicked={() => this.productSelectedHandler(filteredProduct.name)}>
              </Product>
            </div>
        ));
